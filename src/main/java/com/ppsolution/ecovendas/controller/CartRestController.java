...
public class CartRestController {
    ...
    public ResponseEntity<CartResponse> addItem(@Valid @RequestBody CartItemRequest request){
        var cartResponse = service.addItem(request);
    ...
    public ResponseEntity<CartResponse> updateItem(@PathVariable(name = "itemId") Long itemId, @Valid @RequestBody CartItemRequest request){
        var cartResponse = service.updateItemCarrinho(itemId, request);
        return ResponseEntity.ok(cartResponse);
    }
}
